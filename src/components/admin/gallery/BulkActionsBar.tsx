        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
          <div className="flex gap-2">
            <button
              ...
              onClick={onPublish}
              disabled={loading}
              className="flex-1 rounded-md bg-[#012D26] px-3 py-2 text-sm font-medium text-white transition-colors hover:bg-green-900 disabled:opacity-50 sm:flex-none"
            >
              Publish
            </button>
            <button
              ...
              onClick={onUnpublish}
              disabled={loading}
              className="flex-1 rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-800 transition-colors hover:bg-gray-50 disabled:opacity-50 sm:flex-none"
            >
              Unpublish
            </button>
          </div>
